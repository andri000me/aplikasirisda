...
$pdf->Cell(7, 1, 'Scan Surat', 1, 0, 'C');
$pdf->Cell(4, 1, 'Keterangan Surat', 1, 1, 'C');

$no = 1;
$query = "SELECT * FROM tandaterimaagunan";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(7, 2, $row['images'], 1, 0, 'C');
    $pdf->Cell(4, 2, $row['keterangansurat'], 1, 0, 'C');
    $pdf->ln(2);
    $no++;
}
$pdf->Output("laporan_tanda_terima_agunan.pdf", "I");
