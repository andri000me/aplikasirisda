...
<head>
    ...
    <title>Bank BRI Unit Kuin Alalak</title>
    <!-- Font Awesome JS -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light border">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">Bank BRI Unit Kuin Alalak</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <marquee>
                <h3>
                    - SISTEM INFORMASI BANK BRI UNIT KUIN ALALAK - RISDA ROOSYANTIE -
                </h3>
            </marquee>
        </div>
        <div class="row">
